                ...
                return r.unmuteAudio = void 0, r.muteAudio = void 0, r.unmuteVideo = void 0, r.muteVideo = void 0, r.setVideoResolution = function(t) {
                    ...
                    try {
                        if ((e.audio || e.video || e.screen) && void 0 === e.url) {
                            ...
                            if (void 0 !== e.cameraId && "" !== e.cameraId && (l.video.optional = [{
                                    sourceId: e.cameraId
                                }]), void 0 !== e.microphoneId && "" !== e.microphoneId && (l.audio = {
                                    optional: [{
                                        sourceId: e.microphoneId
                                    }]
                                }), p.default.debug(l), (0, c.GetUserMedia)(l, function(e) {
        ...
        var o = n(17),
            ...
            v = function(e) {
                ...
                if (e.session_id = m += 1, "undefined" != typeof window && window.navigator)
                    if (null !== window.navigator.userAgent.match("Firefox")) t.browser = "mozilla", t = (0, l.default)(e);
                    else if (window.navigator.userAgent.indexOf("Safari")) t = (0, s.default)(e), t.browser = "safari";
        ...
        var o = n(11),
            ...
            l = function(e) {
                ...
                return i.init = function(n, r, a) {
                    var l, f, p = (new Date).getTime();
                    t() ? (l = "https://" + i.vocsDomain + ":5668/getvocs/jsonp", f = "https://" + i.proxyDomain + ":8667/getgwcs/jsonp") : (l = "http://" + i.vocsDomain + ":5669/getvocs/jsonp", f = "http://" + i.proxyDomain + ":9667/getgwcs/jsonp"), c(l, {
                        key: n
                    }, function(t) {
                        var c = JSON.parse(t),
                            l = c.error;
                        ...
                        c(f, {}, function(u) {
                            for (var f = JSON.parse(u), m = f.choose_servers, v = !1, g = 0; g < m.length; ++g) l = t() ? "https://" + m[g] + ":5668/getvocs/jsonp" : "http://" + m[g] + ":5669/getvocs/jsonp", c(l, {
                                key: n
                            }, function(t) {
                                var d = JSON.parse(t);
                                if (!v) {
        ...
        var i = n(1),
            ...
            a = function(e) {
                ...
                return n.connection = new WebSocket(e.url), n.requestID = 0, n.sendMessage = function(e, t) {
                    ...
                    console.log(e), n.dispatchEvent((0, i.MediaEvent)({
                        type: "onopen",
                        event: e
                    }))
